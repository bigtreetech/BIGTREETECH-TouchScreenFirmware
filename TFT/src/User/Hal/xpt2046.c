...
#include "GPIO_Init.h"
#include "sw_spi.h"
#include "includes.h"  // for HW_SPI_TOUCH, XPT2046_SPI (IRON_MKS, added for MKS_TFT35_V1_0 support)
...
{
#ifdef HW_SPI_TOUCH  // IRON_MKS, added for MKS_TFT35_V1_0 support
...
uint16_t XPT2046_Read_AD(u8 CMD)
{
  ...
  SPI_Protocol_Init(W25Qxx_SPI, 5);  // IRON, max. ADS7843 SPI clock is 2 MHz, switch to low SPI speed when sampling touch screen, 4-7 works
...
#ifdef MKS_TFT35_V1_0  // IRON_MKS, added for MKS_TFT35_V1_0 support
  SPI_Protocol_Init(W25Qxx_SPI, W25Qxx_SPEED);  // IRON, switch back to high speed SPI
#endif
