...
{
  RCC->AHB1ENR |= W25QXX_SPI_DMA_RCC_AHB;				//����DMAʱ��
  Delay_ms(5);					//�ȴ�DMAʱ���ȶ�
  W25QXX_SPI_DMA_STREAM->PAR = (u32)&W25QXX_SPI_NUM->DR;			//�����ַΪ:SPI->DR
  W25QXX_SPI_DMA_STREAM->M0AR = (u32)&LCD->LCD_RAM;//Ŀ���ַΪLCD_RAM
//  W25QXX_SPI_DMA_STREAM->M1AR = 0; // (used in case of Double buffer mode)
//  W25QXX_SPI_DMA_CHANNEL->CMAR =
  W25QXX_SPI_DMA_STREAM->NDTR = 0;			// DMA,����������,��ʱ����Ϊ0

  W25QXX_SPI_DMA_STREAM->CR = W25QXX_SPI_DMA_CHANNEL << 25;
  W25QXX_SPI_DMA_STREAM->CR |= 1<<16;  // Priority level: Medium
  W25QXX_SPI_DMA_STREAM->CR |= LCD_DATA_16BIT<<13;  //�洢�����ݿ���16λ
  W25QXX_SPI_DMA_STREAM->CR |= LCD_DATA_16BIT<<11;  //�������ݿ���Ϊ16λ
  W25QXX_SPI_DMA_STREAM->CR |= 0<<10;  //�洢��������ģʽ
  W25QXX_SPI_DMA_STREAM->CR |= 0<<9;   //�����ַ������ģʽ
  W25QXX_SPI_DMA_STREAM->CR |= 0<<6;   //�Ǵ洢�����洢��ģʽ
}
