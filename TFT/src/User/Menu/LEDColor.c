...
const LED_VECT ledRed =   {0xFF, 0x00, 0x00, 0xFF, 0x00, 0x00};
const LED_VECT ledGreen = {0x00, 0xFF, 0x00, 0xFF, 0x00, 0x00};
const LED_VECT ledBlue =  {0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00};
const LED_VECT ledWhite = {0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00};
