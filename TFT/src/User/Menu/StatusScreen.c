...
const GUI_RECT rectB[4] = {
  {0*SPACE_X_PER_ICON, 1*(ICON_HEIGHT) - 2.5* BYTE_HEIGHT + 0*SPACE_Y+ICON_START_Y,  1*SPACE_X_PER_ICON,  1*(ICON_HEIGHT) - 2.5* BYTE_HEIGHT +0*SPACE_Y+ICON_START_Y+BYTE_HEIGHT},
  {1*SPACE_X_PER_ICON, 1*(ICON_HEIGHT) - 2.5* BYTE_HEIGHT + 0*SPACE_Y+ICON_START_Y,  2*SPACE_X_PER_ICON,  1*(ICON_HEIGHT) - 2.5* BYTE_HEIGHT +0*SPACE_Y+ICON_START_Y+BYTE_HEIGHT},
  {2*SPACE_X_PER_ICON, 1*(ICON_HEIGHT) - 2.5* BYTE_HEIGHT + 0*SPACE_Y+ICON_START_Y,  3*SPACE_X_PER_ICON,  1*(ICON_HEIGHT) - 2.5* BYTE_HEIGHT +0*SPACE_Y+ICON_START_Y+BYTE_HEIGHT},
  {3*SPACE_X_PER_ICON, 1*(ICON_HEIGHT) - 2.5* BYTE_HEIGHT + 0*SPACE_Y+ICON_START_Y,  4*SPACE_X_PER_ICON,  1*(ICON_HEIGHT) - 2.5* BYTE_HEIGHT +0*SPACE_Y+ICON_START_Y+BYTE_HEIGHT},
};
