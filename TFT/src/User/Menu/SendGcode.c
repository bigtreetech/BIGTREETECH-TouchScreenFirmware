...
const GUI_RECT rect_of_Gkey[]={
  ...
  {5*GKEY_WIDTH, 0*GKEY_HEIGHT+ICON_START_Y, 6*GKEY_WIDTH, 1*GKEY_HEIGHT+ICON_START_Y}, 
  {6*GKEY_WIDTH, 0*GKEY_HEIGHT+ICON_START_Y, 7*GKEY_WIDTH, 1*GKEY_HEIGHT+ICON_START_Y}, 
  ...
  {5*GKEY_WIDTH, 1*GKEY_HEIGHT+ICON_START_Y, 6*GKEY_WIDTH, 2*GKEY_HEIGHT+ICON_START_Y}, 
  {6*GKEY_WIDTH, 1*GKEY_HEIGHT+ICON_START_Y, 7*GKEY_WIDTH, 2*GKEY_HEIGHT+ICON_START_Y}, 
  ...
  {5*GKEY_WIDTH, 2*GKEY_HEIGHT+ICON_START_Y, 6*GKEY_WIDTH, 3*GKEY_HEIGHT+ICON_START_Y}, 
  {6*GKEY_WIDTH, 2*GKEY_HEIGHT+ICON_START_Y, 7*GKEY_WIDTH, 3*GKEY_HEIGHT+ICON_START_Y}, 
  ...
  {6*GKEY_WIDTH, 3*GKEY_HEIGHT+ICON_START_Y, 7*GKEY_WIDTH, 4*GKEY_HEIGHT+ICON_START_Y},

  // Back
  {0*GKEY_WIDTH+5, 0*GKEY_HEIGHT+5,  1*GKEY_WIDTH-5, ICON_START_Y-5},
  // Send
  {6*GKEY_WIDTH+5, 0*GKEY_HEIGHT+5,  7*GKEY_WIDTH-5, ICON_START_Y-5},
};
...
const char * const softKeyValue[][30] = {
  {
    "1", "2", "3", "M", "G", "F", "Del",
    "4", "5", "6", "X", "Y", "Z", "E",
    "7", "8", "9", "S", "T", "P", "Space",
