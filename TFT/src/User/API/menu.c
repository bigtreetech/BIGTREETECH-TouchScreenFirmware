...
const GUI_RECT rect_of_keysIN[TM_RECT_COUNT] = {
  ...
  {0.5*ICON_WIDTH+0*SPACE_X+START_X,  2*ICON_HEIGHT+2*SPACE_Y+ICON_START_Y,  1.5*ICON_WIDTH+0*SPACE_X+START_X,  3*ICON_HEIGHT+2*SPACE_Y+ICON_START_Y},
  {1.5*ICON_WIDTH+1*SPACE_X+START_X,  2*ICON_HEIGHT+2*SPACE_Y+ICON_START_Y,  2.5*ICON_WIDTH+1*SPACE_X+START_X,  3*ICON_HEIGHT+2*SPACE_Y+ICON_START_Y},
  ...
  {0.5*SPACE_X_PER_ICON,  3*ICON_HEIGHT+2*SPACE_Y+ICON_START_Y,  1.5*SPACE_X_PER_ICON,  3*ICON_HEIGHT+3*SPACE_Y+ICON_START_Y},
  {1.5*SPACE_X_PER_ICON,  3*ICON_HEIGHT+2*SPACE_Y+ICON_START_Y,  2.5*SPACE_X_PER_ICON,  3*ICON_HEIGHT+3*SPACE_Y+ICON_START_Y},
...
// VERTICAL GUI 3 icons per row 2 rows last row status bar centered
  ...
  // infobox area
  {0.5*ICON_WIDTH+0*SPACE_X+START_X,  2*ICON_HEIGHT+2*SPACE_Y+ICON_START_Y,  2.5*ICON_WIDTH+1*SPACE_X+START_X,  3*ICON_HEIGHT+3*SPACE_Y+ICON_START_Y}
#else  
...
const GUI_RECT rect_of_keyPS[] = { //PS = PRINT SCREEN, This template is used to locate the live icons on the printing screen.
  ...
  // 3 bottom icons area. it's not used, instead rect_of_keyPS_draw is used because the vertical GUI is using a different Layout in the printing screen
...
//clear gaps all other screents except TFT70
void menuClearGaps(void)
{
#ifdef PORTRAIT
  const GUI_RECT gaps[] = {
