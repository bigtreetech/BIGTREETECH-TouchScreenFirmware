...
#define CONFIG_FLASH_SIGN     20201115 //(YYYYMMDD) change if any keyword(s) in config.ini is added or removed
#define LANGUAGE_FLASH_SIGN   20201115 //(YYYYMMDD) change if any keyword(s) in language pack is added or removed
