...
#define CONFIG_SUPPPORT 20210817

#define FONT_FLASH_SIGN       20210522  // (YYYYMMDD) change if fonts require updating
#define CONFIG_FLASH_SIGN     20210817  // (YYYYMMDD) change if any keyword(s) in config.ini is added or removed
#define LANGUAGE_FLASH_SIGN   20210817  // (YYYYMMDD) change if any keyword(s) in language pack is added or removed
