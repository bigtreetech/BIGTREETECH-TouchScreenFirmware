...
//# HD44780_FULLSCREEN
#define HD44780_XROWS_FULLSCREEN 120.0f
#define HD44780_YROWS_FULLSCREEN 36.0f
#define HD44780_PIXEL_XSIZE_FULLSCREEN      (MIN(LCD_WIDTH/HD44780_XROWS_FULLSCREEN, LCD_HEIGHT/HD44780_YROWS_FULLSCREEN))  // 4
#define HD44780_PIXEL_YSIZE_FULLSCREEN      (HD44780_PIXEL_XSIZE_FULLSCREEN)    // 4 pixel per lcd point
#define HD44780_XSTART_FULLSCREEN ((LCD_WIDTH - HD44780_PIXEL_XSIZE_FULLSCREEN*HD44780_XROWS_FULLSCREEN) / 2)  //0
#define HD44780_YSTART_FULLSCREEN ((LCD_HEIGHT - HD44780_PIXEL_YSIZE_FULLSCREEN*HD44780_YROWS_FULLSCREEN) / 2)  //86

#define HD44780_XROWS 120
#define HD44780_YROWS 36
#define HD44780_PIXEL_XSIZE      (MIN(LCD_WIDTH/HD44780_XROWS, LCD_HEIGHT/HD44780_YROWS))
#define HD44780_PIXEL_YSIZE      (HD44780_PIXEL_XSIZE)
#define HD44780_SIMULATOR_XSTART ((LCD_WIDTH - HD44780_PIXEL_XSIZE*HD44780_XROWS) / 2)
#define HD44780_SIMULATOR_YSTART ((LCD_HEIGHT - HD44780_PIXEL_YSIZE*HD44780_YROWS) / 2)
