...
void setDynamicLabel(uint8_t i, const char * label);  // set list item title to any text
const char * getDynamicLabel(uint8_t i);              // get the custom text of the list item title

void setDynamicTextValue(uint8_t i, const char * txt);  // set list item value to any text (upto 7 characters)
const char * getDynamicTextValue(uint8_t i);            // get the custom text of the list item value
