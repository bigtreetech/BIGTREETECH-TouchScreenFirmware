...
#define _LANGUAGE_PL_H_
    ...
    #define PL_SCREPL_SETTINGS      "Ekran"
    ...
    #define PL_TOUCHSCREPL_ADJUST   "Kalibracja"
    #define PL_MORE                 "Więcej"
    #define PL_SCREPL_INFO          "Info"
    ...
    #define PL_TFTSD                "Karta SD wyświetlacza"
    #define PL_READ_TFTSD_ERROR     "Błąd odczytu kart SD wyświetlacza!"
    #define PL_TFTSD_INSERTED       "Karta włóżona!"
    ...
    #define PL_AUTO_SHUT_DOWN       "Auto Power"
    #define PL_MANUAL_SHUT_DOWN     "Ręczny"
