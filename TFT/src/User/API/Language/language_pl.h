...
#define _LANGUAGE_PL_H_
    ...
    #define STRING_FAN_SPEED_PERCENTAGE   "Prędk. wentyl. w procentach"
    ...
    #define STRING_PL_RECOVERY_HOME       "Pkt bazowy po utracie zas."
    ...
    #define STRING_HOME_OFFSET            "Przesunięcie pozycji bazowej"
    ...
    #define STRING_CUSTOM                 "Niestandard."
    ...
    #define STRING_MARLIN_MODE_SETTINGS   "Tryb Marlin"
