...
#define _LANGUAGE_PL_H_
    ...
    #define STRING_FILE_COMMENT_PARSING   "Analiz. koment. do plików"
    ...
    #define STRING_FILENAME_EXTENSION     "Pokaż rozszerzenie pliku"
    ...
    #define STRING_LED_ALWAYS_ON          "LED pokrętła zawsze wł."
    #define STRING_KNOB_LED_COLOR         "Kolor diody LED pokrętła"
    ...
    #define STRING_TFT_USB_INSERTED       "Dysk USB wyświetlacza włożony"
    #define STRING_TFT_USB_REMOVED        "Dysk USB wyświetlacza wyjęty"
    #define STRING_TFT_USB_NOT_DETECTED   "Nie wykryto dysku USB wyświetlacza!"
    #define STRING_TFT_USB_READ_ERROR     "Błąd odczytu dysku USB wyświetlacza!"
    #define STRING_ONBOARD_SD             "Onboard SD"
    #define STRING_ONBOARD_USB            "OnboardUSB"
    #define STRING_ONBOARD_SD_READ_ERROR  "Błąd odczytu nośnika płyty głównej!"
    ...
    #define STRING_LEVEL_CORNER_INFO      "Odległość od krawędzi jest poniżej przesunięcia sondy X/Y i niektóre punkty docelowe mogą być niedostępne.\nCzy chcesz użyć bezpiecznej odległości od krawędzi?"
    #define STRING_P_OFFSET               "P Offset"
    #define STRING_H_OFFSET               "H Offset"
    #define STRING_DISTANCE               "Dystans"
    #define STRING_SHIM                   "Podkładka"
    ...
    #define STRING_MAIN_SCREEN            "Początek"
