...
#define _LANGUAGE_CN_H_
    ...
    #define CN_MAXFEEDRATE              "Max Feed Rate"
    #define CN_MAXACCELERATION          "Max Acceleration"
    #define CN_ACCELERATION             "Acceleration"
    #define CN_PRINT_ACCELERATION       "Print Acceleration"
    #define CN_RETRACT_ACCELERATION     "Retract Acceleration"
    #define CN_TRAVEL_ACCELERATION      "Travel Acceleration"
    #define CN_BUMP_SENSITIVITY         "TMC bump sensitivity"
    ...
    #define CN_EMERGENCYPARSER          "EMERGENCY_PARSER is disabled in Printer Firmware."
    #define CN_LCD_BRIGHTNESS_DIM       "LCD Brightness dim"
    #define CN_LCD_DIM_IDLE_TIMER       "LCD dim idle timer"
