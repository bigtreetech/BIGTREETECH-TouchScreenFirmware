...
#define _LANGUAGE_CN_H_
    ...
    #define STRING_FILE_COMMENT_PARSING   "Gcode注释解析"
    #define STRING_ROTATED_UI             "旋转界面"
    #define STRING_ACK_NOTIFICATION       "ACK 弹窗类型"
    #define STRING_FILES_SORT_BY          "Gcode排序"
    #define STRING_FILES_LIST_MODE        "文件浏览列表模式"
    #define STRING_FILENAME_EXTENSION     "显示文件扩展名"
    ...
    #define STRING_TFT_SD_NOT_DETECTED    "没有检测到SD卡!"
    #define STRING_TFT_SD_READ_ERROR      "读SD卡出错!"
    #define STRING_TFT_USB                "U盘"
    #define STRING_TFT_USB_INSERTED       "U盘已插入"
    #define STRING_TFT_USB_REMOVED        "U盘已拔出"
    #define STRING_TFT_USB_NOT_DETECTED   "没有检测到U盘!"
    #define STRING_TFT_USB_READ_ERROR     "读U盘出错!"
    #define STRING_ONBOARD_SD             "板载SD"
    #define STRING_ONBOARD_USB            "板载U盘"
    #define STRING_ONBOARD_SD_READ_ERROR  "主板SD卡读取失败!"
    ...
    #define STRING_MARLIN_MODE_SETTINGS   "Marlin模式"
