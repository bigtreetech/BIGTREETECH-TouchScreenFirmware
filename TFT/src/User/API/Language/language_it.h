...
#define _LANGUAGE_IT_H_
    ...
    #define STRING_PRINT_TOTAL_TIME       "Stampa completata.\nDurata totale: %02u:%02u:%02u \n"
    #define STRING_PRINT_FILAMENT_USED    "Filamento usato: %3.2f metri"
    #define STRING_PRINT_SUMMARY          "Sommario"
