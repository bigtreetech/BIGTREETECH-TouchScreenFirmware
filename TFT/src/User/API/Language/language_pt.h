...
#define _LANGUAGE_PT_H_
    ...
    #define STRING_TFT_USB_INSERTED       "USB stick inserido"
    #define STRING_TFT_USB_REMOVED        "USB stick removido"
    #define STRING_TFT_USB_NOT_DETECTED   "No USB stick detected!"
    #define STRING_TFT_USB_READ_ERROR     "Erro a ler USB stick!"
