...
#define _LANGUAGE_UK_H_
    ...
    #define STRING_BL_SMART_FILL        "Відсутні точки \ nзамера були Атоматіческая \ nзаполнени. \ nЗапомніте для сохраніеніе!"
    ...
    #define STRING_ABL_SLOT_EEPROM       "Відновити з осередку \ nпри перезавантаженні? \ n (Зберегти в EEPROM)"
    ...
    #define STRING_IS_PAUSE              "Неможлива екструзія \ nпри друку, поставити \ nна паузу?"
    ...
    #define STRING_WAIT_TEMP_SHUT_DOWN   "Дочекайтеся температури \ nсопла не нижче ніж% d ℃" // Wait for the temperature of hotend to be lower than 50 ℃
    ...
    #define STRING_EEPROM_SAVE_INFO      "Зберегти налаштування \ nпринтера в EEPROM?"
    #define STRING_EEPROM_RESTORE_INFO   "Завантажити налаштування \ nіз EEPROM?"
    #define STRING_EEPROM_RESET_INFO     "скинути EEPROM налаштування \ nпринтера на початкові?"
    ...
    #define STRING_START_PRINT           "Почати друк: \ n% s?"
    ...
    #define STRING_PID_START_INFO        "Зараз буде запущена PID \ nавтонастройка, це займе \ nнекоторое час. Продовжити?"
    #define STRING_PID_START_INFO_2      "Автоналаштування \ nPID в роботе!"
    #define STRING_PID_START_INFO_3      "Не чіпайте екран до \ nзакінчення налаштування \ n (засвітиться зеленим LED)!"
    ...
    #define STRING_TUNE_EXT_TEMPLOW      "Необхідна температура \ nдуже низька! \ nМінімальная температура:% d ℃"
    #define STRING_TUNE_EXT_DESIREDVAL   "Температура ще не досягла необхідного значення"
    #define STRING_TUNE_EXT_MARK120MM    "Відзначте 120 мм на филаменті \ nНажміть '% s' по говності \ nвиміряну отриману довжину \ nпісля екструдування"
    #define STRING_TUNE_EXT_HEATOFF      "Відключити нагрів?"
    #define STRING_TUNE_EXT_ADJ_ESTEPS   "Підстроювання E-кроків"
    #define STRING_TUNE_EXT_ESTEPS_SAVED "E-кроки встановлені! \ nне забудьте зберегти \ nіх в EEPROM \ nНовое значення:% 0.2f"
    ...
    #define STRING_LOAD_STARTED          "Процедура завантаження \ nфіламенту, чекаємо поки хотенд \ nдосягне бажаної температури. \ nбудьласка зачекайте."
    #define STRING_UNLOAD_STARTED        "Процедура вивавантаження. \ nфіламенту, чекаємо поки хотенд \ nдосягне бажаної температури. \ nбудьласка зачекайте."
    #define STRING_HEATERS_ON            "Деякі обігрівачі\ nвсе ще увімкнені. \ nВи хочете їх зупинити?" 
