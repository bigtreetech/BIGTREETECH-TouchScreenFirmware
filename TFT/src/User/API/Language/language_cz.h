...
#define _LANGUAGE_CZ_H_
    ...
    #define CZ_BLTOUCH_DEPLOY       "Spustit"
    #define CZ_BLTOUCH_STOW         "Zvednout"
    #define CZ_BLTOUCH_REPEAT       "Znovu"
