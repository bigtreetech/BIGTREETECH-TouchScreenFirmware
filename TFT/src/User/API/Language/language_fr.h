...
#define _LANGUAGE_FR_H_
    ...
    #define FR_SCREEN_SETTINGS      "Paramètres écran"
    #define FR_MACHINE_SETTINGS     "Paramètres machine"
    ...
    #define FR_ROTATE_UI            "Rotation UI"
    #define FR_TOUCHSCREEN_ADJUST   "Ajuster Touchscreen"
    ...
    #define FR_SMART_RUNOUT_ON      "Smart sensor filament ON"
    ...
    #define FR_ADJUST_FAILED        "Ajustement incorrect, essayez encore"
    ...
    #define FR_UNIFIEDHEAT          "Chauffe / Ventiler"
