...
#define _LANGUAGE_TR_H_
    ...
    #define STRING_DISABLE_STEPPERS       "Motor Durdur"
    ...
    #define STRING_SIMULATOR_BG_COLOR     "Marlin simulatör arkaplan rengi"
    #define STRING_SIMULATOR_FONT_COLOR   "Marlin simulatör font rengi"
    ...
    #define STRING_TERMINAL_ACK           "Terminalde onay mesajlarını göster"
    ...
    #define STRING_SEND_START_GCODE       "Baskı başlangıç gcodeunu kullan"
    #define STRING_SEND_END_GCODE         "Baskı bitiş gcodeunu kullan"
    #define STRING_SEND_CANCEL_GCODE      "Baskı iptal gcodeunu kullan"
    ...
    #define STRING_ST7920_FULLSCREEN      "Marlin modu tam ekranda"
    #define STRING_PLR_EN                 "Güç kesintisinde kurtarma"
    #define STRING_SETTING_SAVE           "Ayarları kaydet"
    #define STRING_SETTING_RESET          "Varsayılan ayarları sıfırla"
    ...
    #define STRING_RETRACT_FEEDRATE       "Geriçekme hızı"
    #define STRING_RETRACT_LENGTH         "Geriçekme mesafesi"
    #define STRING_RETRACT_SWAP_LENGTH    "Geriçekme değişim mesafesi"
    #define STRING_RETRACT_Z_LIFT         "Geriçekme Z sıçraması"
    ...
    #define STRING_ACK_NOTIFICATION       "Onay mesajı bildirim stili"
    #define STRING_LEVELING_EDGE_DISTANCE "Tabla kenar mesafesi"
    #define STRING_XY_UNLOCK              "XY motoru durdur"
    ...
    #define STRING_TUNE_EXTRUDER          "Adımları ayarla"
