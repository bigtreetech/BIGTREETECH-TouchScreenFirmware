...
#define _LANGUAGE_DE_H_
    ...
    #define STRING_DISABLE_STEPPERS       "alle deaktivieren"
    ...
    #define STRING_BLTOUCH_REPEAT         "wiederholen"
    ...
    #define STRING_PLR_EN                 "Wiederaufnahme nach Stromausfall"
    ...
    #define STRING_PRINT_FINISHED         "   Druck\n   beendet."  
    #define STRING_MAIN_SCREEN            "Hauptmenu"
    #define STRING_PREVIOUS_PRINT_DATA    "Info"
    #define STRING_FILE_NAME              "Datei: "
    #define STRING_PRINT_TIME             "Druckzeit: "
    ...
    #define STRING_NO_FILAMENT_STATS      "Keine Filamentstatistik."
    #define STRING_CLICK_FOR_MORE         "Klick für mehr."
