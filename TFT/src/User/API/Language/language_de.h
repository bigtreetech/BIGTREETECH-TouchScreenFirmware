...
#define _LANGUAGE_DE_H_
    ...
    #define STRING_IS_PAUSE               "Extrudieren während Druckvorgang nicht möglich!\nDruck pausieren?"
    ...
    #define STRING_ABL_SLOT_EEPROM        "Slot für den nächsten Neustart merken?\n(Im EEPROM speichern)"
    ...
    #define STRING_PID_START_INFO         "PID Kalibrierung dauert einige Zeit.\nWeitermachen?"
