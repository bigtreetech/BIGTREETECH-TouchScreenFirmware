...
#define _LANGUAGE_DE_H_
    ...
    #define STRING_LCD_IDLE_BRIGHTNESS    "LCD Helligkeit im Standby"
    #define STRING_LCD_IDLE_TIME          "LCD Timer im Standby"
    #define STRING_BLOCK_TOUCH_ON_IDLE    "Blockiere Touch im Idle"
