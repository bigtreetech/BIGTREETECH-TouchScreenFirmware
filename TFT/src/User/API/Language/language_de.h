...
#define _LANGUAGE_DE_H_
    ...
    #define STRING_AUTO_SHUT_DOWN         "'Auto-aus' (PS_ON)"
    ...
    #define STRING_PID_START_INFO         "PID Kalibrierung benötigt\neinige Zeit.\nWeitermachen?"
