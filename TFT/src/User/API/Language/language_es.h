...
#define _LANGUAGE_ES_H_
    ...
    #define ES_EMERGENCYPARSER          "EMERGENCY_PARSER is not enable in your Printer's firmware. Some features may not work properly."
    #define ES_LCD_BRIGHTNESS_DIM       "LCD Brightness dim"
    #define ES_LCD_DIM_TIMER            "LCD dimm timer"
