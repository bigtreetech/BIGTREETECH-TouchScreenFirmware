...
#define _LANGUAGE_SL_H_
    ...
    #define STRING_TFT_SD                 "SD kartica"
    ...
    #define STRING_TFT_USB                "USB diska"
    #define STRING_TFT_USB_INSERTED       "USB diska vstavljen"
    #define STRING_TFT_USB_REMOVED        "USB diska odstranjen"
