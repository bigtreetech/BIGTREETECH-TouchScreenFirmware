...
#define _LANGUAGE_RU_H_
    ...
    #define STRING_PRINT_TOTAL_TIME       "Печать окончена.\nВремя печати: %02u:%02u:%02u \n"
    #define STRING_PRINT_FILAMENT_USED    "Потрачено прутка: %3.2f метров"
    #define STRING_PRINT_SUMMARY          "Конец печати - диалог"
