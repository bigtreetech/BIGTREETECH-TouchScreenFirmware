...
#define _LANGUAGE_RU_H_
    ...
    #define RU_LEDOFF               "OFF" 
    #define RU_LEDWHITE             "White"
    #define RU_LEDRED               "Red"
    #define RU_LEDORANGE            "Orange"
    #define RU_LEDYELLOW            "Yellow"
    #define RU_LEDGREEN             "Green"
    #define RU_LEDBLUE              "Blue"
    #define RU_LEDINDIGO            "Indigo"
    #define RU_LEDVIOLET            "Violet"
