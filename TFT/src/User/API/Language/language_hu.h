...
#define _LANGUAGE_HU_H_
    ...
    #define HU_CURRENT_SETTING          "Meghajtók Aktuális Beállításai"
    #define HU_STEPS_SETTING            "Lépés/mm Beállítás"
    #define HU_MAXFEEDRATE              "Max Feed Rate"
    #define HU_MAXACCELERATION          "Max Acceleration"
    #define HU_ACCELERATION             "Acceleration"
    #define HU_PRINT_ACCELERATION       "Print Acceleration"
    #define HU_RETRACT_ACCELERATION     "Retract Acceleration"
    #define HU_TRAVEL_ACCELERATION      "Travel Acceleration"
    #define HU_BUMP_SENSITIVITY         "TMC bump sensitivity"
    #define HU_RESET                    "Reset"
    #define HU_RESET_SETTINGS           "All settings will be reset to it's default values. Continue?"
