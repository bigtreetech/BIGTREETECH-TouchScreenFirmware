...
#define _LANGUAGE_HU_H_
    ...
    #define HU_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    ...
    #define HU_ACK_POPUP_TYPE         "ACK popup type"
    #define HU_ACK_BUZZER             "ACK buzzer"
    #define HU_LEVELING_EDGE_DISTANCE "Bed edge distance"
    #define HU_XY_UNLOCK              "Kinyit XY"
    #define HU_TUNING                 "Tuning"
    #define HU_PID                    "PID"
    #define HU_PID_TITLE              "PID autotune"
    #define HU_PID_START_INFO         "PID autotune will be started. It can take minutes. Continue?"
    #define HU_PID_START_INFO_2       "PID autotune in progress!"
    #define HU_PID_START_INFO_3       "DO NOT touch the screen until completed (green LED on)!"
    #define HU_EXTRUDE_100            "Ext. 100mm"
    #define HU_CONNECTION_SETTINGS    "Connection"
