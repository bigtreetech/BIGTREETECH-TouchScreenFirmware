...
#define _LANGUAGE_HU_H_
    ...
    #define HU_TOUCH_SOUND            "Touch sounds"
    #define HU_TOAST_SOUND            "Toast Notifications"
    #define HU_ALERT_SOUND            "Popups and Alerts"
