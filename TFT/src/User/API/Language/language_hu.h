...
#define _LANGUAGE_HU_H_
    ...
    #define STRING_PRINT_TOTAL_TIME       "Nyomtatás kész.\nEltelt idő: %02u:%02u:%02u \n"
    #define STRING_PRINT_FILAMENT_USED    "Felhasznált anyag: %3.2f méter"
    #define STRING_PRINT_SUMMARY          "Összegzés"
