...
#define _LANGUAGE_HU_H_
    ...
    #define HU_SEND_START_GCODE     "Kezdés Indítási G-Kódal"
    #define HU_SEND_END_GCODE       "Leállás Befejező G-Kódal"
    #define HU_PERSISTANT_STATUS_INFO "Perzisztens állapotinfó"
    #define HU_FILE_LISTMODE        "Fájlnéző lista módban"
    #define HU_CURRENT_SETTING      "Meghajtók Beállításai"
