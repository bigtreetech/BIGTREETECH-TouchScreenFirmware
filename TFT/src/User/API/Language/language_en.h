...
#define _LANGUAGE_EN_H_
    ...
    #define STRING_TFT_SD_INSERTED        "TFT SD card inserted!"
    #define STRING_TFT_SD_REMOVED         "TFT SD card removed!"
    #define STRING_TFT_SD_NOT_DETECTED    "No TFT SD card detected."
    #define STRING_TFT_USB                "TFT USB"
    #define STRING_TFT_USB_READ_ERROR     "Read TFT USB disk error!"
    #define STRING_TFT_USB_INSERTED       "TFT USB disk inserted!"
    #define STRING_TFT_USB_REMOVED        "TFT USB disk removed!"
    #define STRING_TFT_USB_NOT_DETECTED   "No TFT USB disk detected."
