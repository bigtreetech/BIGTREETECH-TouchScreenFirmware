...
#define _LANGUAGE_EN_H_
    ...
    #define STRING_TFT_USB_INSERTED       "USB stick inserted"
    #define STRING_TFT_USB_REMOVED        "USB stick removed"
    #define STRING_TFT_USB_NOT_DETECTED   "No USB stick detected!"
    #define STRING_TFT_USB_READ_ERROR     "USB stick reading error!"
