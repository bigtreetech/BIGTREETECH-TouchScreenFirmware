...
#define _LANGUAGE_NL_H_
    ...
    #define STRING_TFT_USB_INSERTED       "USB stick geplaatst"
    #define STRING_TFT_USB_REMOVED        "USB stick verwijdert"
    #define STRING_TFT_USB_NOT_DETECTED   "No USB stick detected!"
    #define STRING_TFT_USB_READ_ERROR     "USB stick leesfout!"
