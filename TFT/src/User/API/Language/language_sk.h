...
#define _LANGUAGE_SK_H_
    ...
    #define SK_CURRENT_SETTING          "Driver Current (mA)"
    #define SK_STEPS_SETTING            "Steps per MM"
    #define SK_MAXFEEDRATE              "Max Feed Rate"
    #define SK_MAXACCELERATION          "Max Acceleration"
    #define SK_ACCELERATION             "Acceleration"
    #define SK_PRINT_ACCELERATION       "Print Acceleration"
    #define SK_RETRACT_ACCELERATION     "Retract Acceleration"
    #define SK_TRAVEL_ACCELERATION      "Travel Acceleration"
    #define SK_BUMP_SENSITIVITY         "TMC bump sensitivity"
    ...
    #define SK_EMERGENCYPARSER          "EMERGENCY_PARSER is disabled in Printer Firmware."
