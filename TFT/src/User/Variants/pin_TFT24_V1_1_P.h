#ifndef _PIN_TFT24_V1_1_P_H_ // modify to actual filename !!!
#define _PIN_TFT24_V1_1_P_H_ // modify to actual filename !!!
...
//Global Variable to query if Portrait mode is used
#define PORTRAIT
