...
// LCD interface
  ...
  #define TFTLCD_DRIVER       (ILI9488 | NT35310)  // Type of LCD driver, now support[RM68042, ILI9488, ILI9341, ST7789, HX8558, SSD1963].
...
// LCD Encoder/Knob support, can be added using available pins (PB0, PB1, PB4, PB5). Switch encoder/button to ground.
